...
class quaternion:
	...
	def __mul__(self, other):
		prod0 = self[0] * other[0] - self[1] * other[1] - self[2] * other[2] - self[3] * other[3]
		prod1 = self[0] * other[1] + self[1] * other[0] + self[2] * other[3] - self[3] * other[2]
		prod2 = self[0] * other[2] + self[2] * other[0] + self[3] * other[1] - self[1] * other[3]
		prod3 = self[0] * other[3] + self[3] * other[0] + self[1] * other[2] - self[2] * other[1]
